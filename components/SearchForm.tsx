...
const SearchForm = () => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        if (values.dates.from.getDate() === values.dates.to.getDate()) {
            alert("oh no")
        }
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col">
                                <FormLabel
                                    className="text-white">Dates</FormLabel>
                                <FormMessage />
                                <Popover>
                    ...
                    <div className="grid items-center flex-1">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    <FormLabel
                                        className="text-white">Adults</FormLabel>
                                    <FormMessage />
                                    <FormControl>
                                        <Input type="number" min="1" max="12" placeholder="Adults" {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />
                    ...
                    <div className="grid items-center flex-1">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    <FormLabel
                                        className="text-white">Children</FormLabel>
                                    <FormMessage />
                                    <FormControl>
                    ...
                    <div className="grid items-center flex-1">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    <FormLabel
                                        className="text-white">Rooms</FormLabel>
                                    <FormMessage />
                                    <FormControl>
                                        <Input type="number" min="1" placeholder="rooms" {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />
