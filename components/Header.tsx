        ...
        <header className="bg-[#013B94]">
            ...
            >
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                            ...
                            >
                                ...
                                >
                                    {callsToAction.map((item) => (
                                        ...
                                        >
                                            <item.icon
                                                className="h-5 w-5 float-none text-[#013B94]"
                                                aria-hidden="true"
                                            />
                                            {item.name}
                                        </a>
                    ...
                    <a href="#" className="text-sm font-semibold leading-6 text-white"> Flights
                    </a>
                    <a href="#" className="text-sm font-semibold leading-6 text-white"> Car Rentals
                    </a>
                ...
                >
                    ...
                    <Dialog.Panel
                        className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
                    >
...
items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-blue-800"
                                                    >
                                                        Stays
                                                        <ChevronDownIcon
                                                            className={cn(
...
hover:bg-blue-800">
                                    ...
                                    <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-blue-800"> Flights
                                    </a>
                                    <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-blue-800"> Car Rentals
                                    </a>
